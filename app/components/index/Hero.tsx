...
import useHover3d from "~/hooks/useHover";
import obet from "~/assets/obet.jpg"
const Hero = () => {
    ...
    return (
        <div className="bg-white bg-grid-small-white/[0.2]" id="home">
            <NavBar />
                ...
                <div
                    ...
                    <div className="space-y-2 max-w-4xl mx-auto">
                        <div className="flex justify-between">
                            ...
                            <motion.div
                                ...
                                <img
                                    src={obet}
                                    alt="Profile"
                                    className='w-40  absolute h-40 top-0 md:top-4 right-4 rounded-full border-2 border-secondary'
                                    style={{
                        ...
                        <CustomButton
                            ...
                            svg={
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#333" className="w-5 h-5">
